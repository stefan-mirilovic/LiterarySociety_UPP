...
INSERT INTO public.user_table(
	id, city, country, email, enabled, name, password, role, surname)
	VALUES (10003, 'Sremska Mitrovica','Srbija', 'committee1@maildrop.cc', true, 'Marija', '$2y$10$ZZ2O5tExTIbunC8EmUGPkORPsFDiFi908Y9BMeq1y7AOHLW/i2zUa', 5,'Marijic');

INSERT INTO public.user_table(
	id, city, country, email, enabled, name, password, role, surname)
	VALUES (10004, 'Sremska Mitrovica','Srbija', 'committee2@maildrop.cc', true, 'Nikola', '$2y$10$ZZ2O5tExTIbunC8EmUGPkORPsFDiFi908Y9BMeq1y7AOHLW/i2zUa', 5,'Nikolic');
...
INSERT INTO public.user_table(
	id, city, country, email, enabled, name, password, role, surname)
	VALUES (10006, 'Novi Sad','Srbija', 'committee-leader@maildrop.cc', true, 'Squidward', '$2a$10$ndWj8PyA9OEtQ9raNstHTer2NRdF5oucTXnS5/ygAVQqjJrVxHGCm', 6,'Tentacles');
