...
public class CheckPublish implements JavaDelegate {
    @Override
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        for (FormSubmissionDto form : synopsisForm) {
            if (form.getFieldId().equals("publish")) {
        ...
        delegateExecution.setVariable(PropertyName.BookPublishing.PUBLISH_BOOK, accept);
    }
}
