...
public class MoreCorrection implements JavaDelegate {
    @Override
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        for (FormSubmissionDto form : synopsisForm) {
            if (form.getFieldId().equals("more")) {
        ...
        delegateExecution.setVariable(PropertyName.BookPublishing.MORE_CORRECTION, accept);
    }
}
