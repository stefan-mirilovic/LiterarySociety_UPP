package upp.demo.elastic.configuration;
...
import upp.demo.elastic.plugin.SerbianPlugin;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "upp.demo.elastic.repository")
public class ElasticConfiguration {
    public Client nodeClient() {
        ...
        Settings settings = Settings.builder()
                ...
                .put("cluster.name", "literary-society")
                .put("http.port", 9201)
                .put("node.name", "literary-society-node")
